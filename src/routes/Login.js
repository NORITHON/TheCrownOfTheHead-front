    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                <StyledButton id="1" component={Link} to="/" onClick={onClick} sx={{mt: 2}}>Sign up as designer</StyledButton>
                <StyledButton id="2" component={Link} to="/" onClick={onClick}>Sign up as client</StyledButton>
